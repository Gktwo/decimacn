...
@MenuItemRegistration(parent = CTX_MENU_CORE_EDITOR_ID, id = CTX_MENU_CORE_EDITOR_DECORATION_ID, name = "&в╟йн", group = CTX_MENU_CORE_EDITOR_GROUP_GENERAL, order = 2000)
