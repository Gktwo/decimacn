...
@MenuItemRegistration(parent = CTX_MENU_EDITOR_STACK_ID, name = "&¹Ø±Õ", icon = "Editor.closeIcon", keystroke = "ctrl F4", group = CTX_MENU_EDITOR_STACK_GROUP_CLOSE, order = 1000)
