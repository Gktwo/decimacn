...
@MenuItemRegistration(parent = CTX_MENU_EDITOR_STACK_ID, name = "关闭 &未初始化的选项卡", icon = "Editor.closeUninitializedIcon", group = CTX_MENU_EDITOR_STACK_GROUP_CLOSE, order = 4000)
